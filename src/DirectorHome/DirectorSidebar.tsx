...
import type { DirectorInfoResponse } from './DirectorHome.types'
...
/**
 * Sidebar for the Director Dashboard
 */
export const DirectorSidebar = (props: Props) => {
  const { directorData, setSidebarOpen, sidebarOpen } = props
    ...
    <>
                  ...
                  <div className="flex items-center">
                    {/* <div>
                      <img
                        ...
                        src={directorData.photo || LOGO}
                        alt=""
                      />
                    </div> */}
                    <div className="ml-3">
                      <p className="text-base font-medium text-white">
                        {directorData.businessName}
                      </p>
                    </div>
                  </div>
                </a>
      ...
      <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
        <div className="flex-1 flex flex-col min-h-0 bg-black">
          ...
          <div className="shrink-0 flex border-t border-gray-500 p-4">
            <a href="/manage/account/" className="shrink-0 w-full group block">
              <div className="flex items-center">
                {/* <div>
                  <img
